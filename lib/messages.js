...
const en = {
  ...
  products: {
    ...
    lines: [
      ...
      },
      {
        ...
        description:
          "Built from European beechwood with ergonomic grip angles. Anti-slip pads keep them planted on any surface — wood, tile, or gym mats.",
  ...
  craft: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Push-up stands use a stable ergonomic angle designed for reliable, wrist-friendly support during floor training.",
      },
      {
        title: "Honest design",
  ...
  legal: {
    privacy: {
      meta: {
        title: "Privacy | KRAFIT",
        description: "How KRAFIT handles personal data on krafit.eu.",
      },
      title: "Privacy",
      updated: "Last updated: June 2026",
      intro:
        "A short note on how this static product website handles data.",
      controllerTitle: "Who is responsible",
      sections: [
        {
          title: "What data is processed",
          body:
            "This website presents KRAFIT products and provides a downloadable training guide. We do not operate a newsletter signup, customer account, or contact form. If you email us, we process only the information you choose to include in your message so we can respond.",
        },
        {
          title: "Server and hosting logs",
          body:
            "Our hosting provider, Vercel, may process technical data such as IP address, browser type, request time, and pages viewed to deliver the site securely and reliably.",
        },
        {
          title: "Cookies and analytics",
          body:
            "We do not use marketing cookies or analytics tools. Fonts, product images, and PDF files are served directly through this website. Vercel may process essential server logs to operate the service.",
        },
        {
          title: "External links",
          body:
            "Some links lead to Amazon product pages. Once you follow an external link, the privacy terms of that provider apply.",
        },
        {
          title: "Your rights",
          body:
...
const de = {
  ...
  products: {
    ...
    lines: [
      ...
      },
      {
        ...
        description:
          "Aus europäischem Buchenholz mit ergonomischen Griffwinkeln. Anti-Rutsch-Pads sorgen für stabilen Halt auf jeder Oberfläche — Holz, Fliesen oder Trainingsmatten.",
  ...
  craft: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Die Liegestützgriffe nutzen einen stabilen ergonomischen Winkel für zuverlässige, handgelenkschonende Unterstützung beim Bodentraining.",
      },
      {
  ...
  legal: {
    privacy: {
      meta: {
        title: "Datenschutz | KRAFIT",
        description: "Wie KRAFIT personenbezogene Daten auf krafit.eu verarbeitet.",
      },
      title: "Datenschutz",
      updated: "Stand: Juni 2026",
      intro:
        "Kurze Hinweise zur Nutzung dieser statischen Produktwebsite.",
      controllerTitle: "Verantwortliche Stelle",
      sections: [
        {
          title: "Welche Daten verarbeitet werden",
          body:
            "Diese Website dient der Produktvorstellung und dem Download eines Trainingsguides. Wir betreiben keine Newsletter-Anmeldung, kein Kundenkonto und kein Kontaktformular. Wenn Sie uns per E-Mail schreiben, verarbeiten wir nur die Angaben, die Sie uns in Ihrer Nachricht freiwillig senden, damit wir antworten können.",
        },
        {
          title: "Server- und Hosting-Protokolle",
          body:
            "Unser Hosting-Anbieter Vercel kann technische Daten wie IP-Adresse, Browsertyp, Anfragezeitpunkt und aufgerufene Seiten verarbeiten, um die Website sicher bereitzustellen.",
        },
        {
          title: "Cookies und Analyse",
          body:
            "Wir setzen keine Marketing-Cookies und keine Analyse-Tools ein. Schriftarten, Produktbilder und PDF-Dateien werden direkt über diese Website ausgeliefert. Vercel kann technisch notwendige Server-Protokolle für den Betrieb verarbeiten.",
        },
        {
          title: "Externe Links",
          body:
            "Einige Links führen zu Amazon-Produktseiten. Sobald Sie einem externen Link folgen, gelten die Datenschutzbestimmungen des jeweiligen Anbieters.",
        },
        {
          title: "Ihre Rechte",
          body:
