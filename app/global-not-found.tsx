...
export default function GlobalNotFound() {
  return (
    <html lang="en">
      <body className="flex min-h-screen items-center justify-center bg-background-warm px-6 py-16 text-foreground">
        <main className="w-full max-w-2xl border border-border-strong bg-surface p-8 text-center sm:p-12">
          <p className="label-kicker">404</p>
          <h1 className="mt-5 text-4xl font-semibold uppercase">
